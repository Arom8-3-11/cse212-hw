...
// Console.WriteLine("\n======================\nSimple Queue\n======================");
// // think of the image that was shown, it looks backwards but this is the order that
// // it will go in the order that items are enqueued and dequeued (first in, first out)
