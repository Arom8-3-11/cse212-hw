...
// Console.WriteLine("\n======================\nSimple Stack\n======================");
// // push and pop, what it will do is to push in the number within the () and with pop,it will take out the last number or variable that was inserted/ or whichever one is requested to be taken out
