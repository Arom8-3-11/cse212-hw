...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: No defect found; the finite-turn sequence passed.
    ...
    // Defect(s) Found: No defect found; adding a person midway produced the expected sequence.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with zero turns were not re-enqueued, so infinite turns did not work.
    ...
    // Defect(s) Found: People with negative turns were not re-enqueued, so infinite turns did not work.
    ...
    // Defect(s) Found: No defect found; the empty queue threw the expected exception and message.
